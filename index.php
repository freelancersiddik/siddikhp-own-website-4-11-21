    ...
    <div class="container-fluid home_page main_box">
        <div class="home_social_link mx-auto d-none d-sm-none d-md-block">
            <div class="link_icons mx-3">
                <a href="https://www.facebook.com/lxsiddikxx" target="_blank" class="text-decoration-none"><i class="fab fa-facebook"></i></a>
                <a href="https://www.instagram.com/siddik3446/" target="_blank" class="text-decoration-none"><i class="fab fa-instagram"></i></a>
                <a href="https://www.linkedin.com/in/siddik-hp-06688321b/" target="_blank" class="text-decoration-none"><i class="fab fa-linkedin"></i></a>
                <a href="https://twitter.com/Siddik85293666" target="_blank" class="text-decoration-none"><i class="fab fa-twitter"></i></a>
            </div>
        </div>
        <div class="row">
